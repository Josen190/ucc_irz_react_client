...
export const url_get_cabinets_id_events = (id) => { return `/api/cabinets/${id}/events`};
export const url_put_cabinets_id = (id) => { return `/api/cabinets/${id}`};
export const url_delete_cabinets_id = (id) => { return `/api/cabinets/${id}`};
...
export const url_get_events_id = (id) => {return `/api/events/${id}`};
export const url_delete_events_id = (id) => {return `/api/events/${id}`};
export const url_post_events = '/api/events';

// Изображения
export const url_get_images_id = (id) => {return `/api/images/${id}`};

// Сообщения 
export const url_get_messages = '/api/messages';
export const url_post_messages = '/api/messages';
export const url_delete_messages_id = (id) => {return `/api/messages/${id}`};

// новости
export const url_get_news = `/api/news`;
export const url_post_news = `/api/news`;
export const url_get_news_id = (id) => {return `/api/news/${id}`};
...
export const url_delete_news_comments_id = (id) => {return `/api/news_comments/${id}`};
...
export const url_put_positions_id = (id) => {return `/api/positions${id}`};
export const url_post_positions_add_pos_to_user = '/api/positions/add_pos_to_user';
export const url_post_positions_remove_user_position = '/api/positions/remove_user_position';
...
// Подписки
export const url_get_subscriptions_user_subscribers = '/api/subscriptions/user_subscribers';
export const url_get_subscriptions_my_subscribers = '/api/subscriptions/my_subscribers';
export const url_get_subscriptions_user_subscriptions = '/api/subscriptions/user_subscriptions';
export const url_get_subscriptions_my_subscriptions = '/api/subscriptions/my_subscriptions';
export const url_post_subscriptions_subcribe = '/api/subscriptions/subcribe';
export const url_post_subscriptions_unsubscribe = '/api/subscriptions/unsubscribe';
...
export const url_get_users_id = (id) => {return `/api/users/${id}`};
...
export const url_post_users_management_register = "/api/users_management/register";
export const url_put_users_management_id_update_reg_info = (id) => {return `/api/users_management/${id}/update_reg_info`};
export const url_delete_users_management_id = (id) => {return `/api/users_management/${id}`};
export const url_put_users_management_id_activate = (id) => {return `/api/users_management/${id}/activate`};
export const url_put_users_management_id_deactivate = (id) => {return `/api/users_management/${id}/deactivate`};
